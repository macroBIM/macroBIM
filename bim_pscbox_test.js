...
(function () {
  ...
  function ensureDeps(cb) {
    ...
    if (!hasGlobal('geo_box12cell')) need.push(PAGES + 'bim_box12cell.js?v=2');
  ...
  var CSS =
    ...
    '.px-root .draw-card{background:#fff;border:1px solid var(--line);border-radius:10px;overflow:hidden;margin-bottom:18px;}' +
    '.px-root .draw-card-header{display:flex;justify-content:space-between;align-items:center;gap:10px;padding:10px 16px;background:#f8fafc;border-bottom:1px solid var(--hair);flex-wrap:wrap;}' +
    '.px-root .draw-card-title{font-weight:700;font-size:14px;}' +
    '.px-root .draw-card-desc{font-weight:400;color:#94a3b8;font-size:12px;}' +
    '.px-root .draw-card-body{padding:14px 16px;}' +
