...
`PLATE3D_GGB.mp4` — 124초 · 1920×1080 · 30 fps · 15.2 MB · 무음
...
| 구간 | 시간 | 내용 |
|---|---|---|
| 1 | 0–6 | 오프닝 카드 · **MODELLING THE GOLDEN GATE BRIDGE. SIMPLE AND FAST.** |
...
| 12 | 102–112 | DXF 아홉 장 → 일반도, 전장 2,311,505 |
| 13–14 | 112–124 | 2,219부재 · 81,624 t · 로고 |
...
node shoot_ggb.js         # 촬영 — 680 스틸, 약 25분
