/*
    bim_rect_3d.js — Three.js 3D renderer for Rect section extrusion.
    Supports hollow (중공) and solid (충실) sections.
*/
function _exportSTL(meshes, filename) {
...
function render_rect_3d(containerId, geoBegin, geoEnd, segLength) {
    ...
    btnSTL.onclick = function() { _exportSTL(allMeshes, 'rect_section.stl'); };
