/*
    bim_octagon_3d.js — Three.js 3D renderer for Octagon section extrusion.
    Supports hollow (중공) and solid (충실) sections.
*/
function _exportSTL_octagon(meshes, filename) {
...
function render_octagon_3d(containerId, geoBegin, geoEnd, segLength) {
    ...
    btnSTL.onclick = function() { _exportSTL_octagon(allMeshes, 'octagon_section.stl'); };
